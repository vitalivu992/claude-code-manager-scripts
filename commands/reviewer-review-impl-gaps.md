...
Otherwise, enter the "Plan mode", create a detailed plan to address major/blocking issues, make sure to include the update documents, tests. For each issue, explicitly note the criterias for passing.
